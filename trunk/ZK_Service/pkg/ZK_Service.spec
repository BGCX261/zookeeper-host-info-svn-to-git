...
#%define _prefix /home/muyanxue/rpm/ZK_Service
%define _prefix /home/s/apps/ZK_Service
%define srcname ZK_Service
...
%description
ZK_Service aim at show host information accord to ZK_Serviced
...
cp -rf scripts/ZK_Service_clean_crontab %{buildroot}/%{_sysconfdir}/cron.d/
popd
...
%defattr(-,root,root)
%{_sysconfdir}/cron.d/ZK_Service_clean_crontab
...
%{_prefix}/bin/stop.sh ZK_Service
